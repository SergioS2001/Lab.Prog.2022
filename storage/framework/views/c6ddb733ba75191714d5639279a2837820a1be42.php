                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 order-details">
                                <h4>Shipping Details
                                    <a href="<?php echo e(url('orders')); ?>" class="btn btn-warning text-white float-end">Back</a>
                                </h4>
                                <hr>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $orders->orderitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src=" <?php echo e(asset('assets/uploads/product/'.$item->products->image)); ?>" width="50px" alt="Product Image">
                                                </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\store\resources\views/admin/orders/view.blade.php ENDPATH**/ ?>